...
Sau khi khám phá 1 lúc thì cũng ko có gì đăc biệt ngoài 1 form login và 1 tài khoản guess
...
"Basic access tier - Monitoring capabilities only"
```



Ta có thể thấy được có 2 phần chính&#x20;

* Phần đầu thì chỉ có role cao hơn mới có thể xem được nó&#x20;
* Phần thứ 2 la 1 công cụ phân tích thông qua url --> khả năng cao sẽ bị nhiễm SSRF nếu ko validate kĩ

<figure><img src="../.gitbook/assets/image (654).png" alt=""><figcaption></figcaption></figure>



Tôi sẽ tiến hành test thử bằng công cụ có sẵn trên burp&#x20;

<figure><img src="../.gitbook/assets/image (655).png" alt=""><figcaption></figcaption></figure>

Và ta có thể CF rằng đây chính là SSRF
...
Dựa vào file này , ta có được 1 số thông tin quan trọng sau :

* cred để truy cập vào database

```
const couchdbUrl = 'http://admin:waxcircle2025@127.0.0.1:5984'; 
```

* username của tài khoản có role guardian
...
* Và đây chính là couchdb



## EXPLOIT

Ta sẽ tiến hành liệt kê toàn bộ bảng ra bằng&#x20;
...
đến đây , kết hợp với việc ta đã biết dc username của 1 người có role guardian rồi , ta sẽ sử dụng payload :&#x20;
...
{
"_id":"user_elin_croft",
"_rev":"1-24d81f04d60b88049638e179f07dd019",
"type":"user",
"username":"elin_croft",
"password":"&aIg*Y#GncCbV^oS",
"role":"guardian",
"clearance_level":"divine_authority"
}
```
...
```
HTB{w4x_c1rcl3s_c4nn0t_h0ld_wh4t_w4s_n3v3r_b0und_01f4d7974a23fa396ed4589687cb11b5}
```
