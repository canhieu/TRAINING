...
```bash
rustscan -a 10.129.229.26 --ulimit 5000 -b 1500 -- -Pn
```
...
```bash
nmap -sC -sV -A -p22,5555 10.129.229.26
...
|     Date: Fri, 08 May 2026 04:34:07 GMT
|     Content-Length: 75
...
|     Location: /web
|     Date: Fri, 08 May 2026 04:33:51 GMT
|     Content-Length: 27
|     href="/web">Found</a>.
|   HTTPOptions: 
|     HTTP/1.0 200 OK
...
SF-Port55555-TCP:V=7.98%I=7%D=5/8%Time=69FD67AF%P=x86_64-pc-linux-gnu%r(Ge
SF:tRequest,A2,"HTTP/1\.0\x20302\x20Found\r\nContent-Type:\x20text/html;\x
SF:20charset=utf-8\r\nLocation:\x20/web\r\nDate:\x20Fri,\x2008\x20May\x202
SF:026\x2004:33:51\x20GMT\r\nContent-Length:\x2027\r\n\r\n<a\x20href=\"/we
